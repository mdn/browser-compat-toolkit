...
const equalTrimmed = (actual, expected, message = null) => {
...
describe('test "mdnFeatureTable"', () => {
  it('Outputs a message if there is no data for the query "foo.bar"', () => {
    ...
    return equalTrimmed(actual, expected)
  })
  ...
  it('Creates correct feature labels for bare features', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr th').innerHTML, 'Basic support')
    equalTrimmed(dom.querySelector('.bc-table tbody tr:nth-child(2) th').innerHTML, '<code>bareSubFeature</code>')
  })
  it('Creates correct feature labels for features with descriptions', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr th').innerHTML, 'Basic support')
    equalTrimmed(dom.querySelector('.bc-table tbody tr:nth-child(2) th').innerHTML, '<code>Interface()</code> constructor')
  })
  it('Creates correct feature labels for features with an MDN URL', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr th').innerHTML, 'Basic support')
    equalTrimmed(dom.querySelector('.bc-table tbody tr:nth-child(2) th').innerHTML,
  ...
  it('Creates correct labels for experimental/non-standard features', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr th').textContent, 'Basic support Experimental')
    equalTrimmed(dom.querySelector('.bc-table tbody tr:nth-child(2) th').textContent,
  ...
  it('Creates correct labels for deprecated features with a description', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr th').textContent, 'Basic support Deprecated')
    equalTrimmed(dom.querySelector('.bc-table tbody tr:nth-child(2) th').textContent,
  ...
  it('Creates correct cell content for no support', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr td:nth-child(4) abbr span').textContent, 'No support')
  ...
  it('Creates correct cell content for unknown version support', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr td:nth-child(4) abbr span').textContent, 'Full support')
  ...
  it('Creates correct cell content for partial support and known version number', () => {
    ...
    equalTrimmed(dom.querySelector('.bc-table tbody tr td:nth-child(4) abbr span').textContent, 'Partial support')
    assert.include(dom.querySelector('.bc-table tbody tr td:nth-child(4)').textContent, '25')
  })
  ...
  it('Creates correct notes for flags', () => {
    ...
    equalTrimmed(dom.querySelectorAll('section.bc-history dl dd')[0].textContent,
    ...
    equalTrimmed(dom.querySelectorAll('section.bc-history dl dd')[1].textContent,
      'Disabled From version 17: this feature is behind the --number-format-to-parts runtime flag.')
    equalTrimmed(dom.querySelectorAll('section.bc-history dl dd')[2].textContent,
      '') // empty for the "version_added: 12" range that has no flag
    equalTrimmed(dom.querySelectorAll('section.bc-history dl dd')[3].textContent,
    ...
    equalTrimmed(dom.querySelectorAll('section.bc-history dl dd')[4].textContent,
      'Disabled From version 45: this feature is behind the foo.enabled preference and the bar.enabled preference.')
    equalTrimmed(dom.querySelectorAll('section.bc-history dl dd')[5].textContent,
